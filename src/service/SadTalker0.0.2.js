...
class SadTalker {
  ...
  downloadPkg = async (callback) => {
    await download({ out: "SadTalker.zip", url: "https://ghproxy.com/https://github.com/OpenTalker/SadTalker/archive/ae69a4c57c9838370643dd2c9b7d1f6ba16a54d8.zip" }, callback);
  };
  move = async (callback) => {
  ...
  downloadModels2 = async (callback) => {
  ...
  downloadModels = async (callback) => {
    ...
    const downloadList = [
      ...
      {
        url: "https://ghproxy.com/https://github.com/OpenTalker/SadTalker/releases/download/v0.0.2-rc/SadTalker_V0.0.2_256.safetensors",
        out: "/SadTalker_V0.0.2_256.safetensors",
        dir: checkpointsPath,
      },
      {
        url: "https://ghproxy.com/https://github.com/OpenTalker/SadTalker/releases/download/v0.0.2-rc/SadTalker_V0.0.2_512.safetensors",
        out: "/SadTalker_V0.0.2_512.safetensors",
        dir: checkpointsPath,
      },
      { url: "https://ghproxy.com/https://github.com/xinntao/facexlib/releases/download/v0.1.0/alignment_WFLW_4HG.pth", out: "alignment_WFLW_4HG.pth", dir: weightsPath },
      {
